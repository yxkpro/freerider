            ...
            if(this.I[x] != undefined && this.I[x][y] != undefined)
            {
                if(this.I[x][y].AG.length > 0 || this.I[x][y].AL.length > 0)
                {
                    ...
                    if(this.Ax[x + "_" + y] == undefined)
                    {
                        ...
                        this.Ax[x + "_" + y].width = this.q * this.zoom;
                        this.Ax[x + "_" + y].height = this.q * this.zoom;
                        ...
                        {
                            this.I[x][y].AL[v].draw(this.Ax[x + "_" + y].getContext("2d"), x * this.q * this.zoom, y * this.q * this.zoom);
                        }
                        Au.strokeStyle = "black";
                        if(lineShaded)
                        {
                        ...
                        {
                            this.I[x][y].AG[P].draw(this.Ax[x + "_" + y].getContext("2d"), x * this.q * this.zoom, y * this.q * this.zoom);
                        }
                    }
                    B.drawImage(this.Ax[x + "_" + y], Math.floor(p.width / 2 - this.A5.x * this.zoom + x * this.q * this.zoom), Math.floor(p.height / 2 - this.A5.y * this.zoom + y * this.q * this.zoom));
                }
                B.strokeStyle = "black";
                for(var j = 0; j < this.I[x][y].AD.length; j++)
                {
...
function mouseScroll(AE)
{
    ...
    if(shift)
    {
        ...
        {
        	if((AE.detail > 0 || AE.wheelDelta < 0) && gridSizeWhenActivated > 2)
        	{
